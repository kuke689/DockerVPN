...
ADD ./root /
RUN chmod +x /opt/vpnserver/vpnserver /opt/vpnserver/vpncmd /usr/sbin/run /usr/sbin/tinyproxy /usr/sbin/mproxy /etc/rc.d/init.d/mproxy /usr/sbin/updatevpn /usr/sbin/rinetd 
