...
ADD ./root /
RUN chmod +x /opt/vpnserver/vpnserver /opt/vpnserver/vpncmd /opt/vpnserver/hamcore.se2 /usr/sbin/run /usr/sbin/monitor /usr/sbin/tinyproxy /usr/sbin/mproxy /etc/rc.d/init.d/mproxy /usr/sbin/updatevpn
